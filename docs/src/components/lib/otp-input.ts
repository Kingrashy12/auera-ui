import { cva, VProps } from "auera-ui";
import { useMemo } from "react";
import { createStyle, tw } from "stywind";

// TODO: Add the in-spinn to `aueraTw`
const input = cva(
    ...
    variants: {
      error: {
        ...
        false: `focus:border-blue-500 caret-black border-neutral-300 tone-dark:text-white 
          tone-dark:border-[1.95px] tone-dark:shadow-neutral-900 tone-dark:border-neutral-800 tone-dark:caret-white`,
      },
...
export const useComputeInput = (
  ...
  // Replace `input` and `div` with auera elements
  const Input = useMemo(
